...
const PRODUCT_BASE = "https://product-service-jzzf.onrender.com/api/v1/products";
...
export const API_ENDPOINTS = {
  ...
  GET_SEARCH_PRODUCTS: (keyword: string) => `${PRODUCT_BASE}/search?keyword=${keyword}`,
  ...
  GET_PRODUCT_REVIEWS: (productId: string) => `${REVIEW_BASE}/product/${productId}`,
};
